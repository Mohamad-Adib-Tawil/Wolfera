...
class Env {
  ...
  static const firebaseIosMessagingSenderId =
      String.fromEnvironment('FIREBASE_IOS_MSG_SENDER_ID', defaultValue: '');
  static const firebaseIosProjectId =
      String.fromEnvironment('FIREBASE_IOS_PROJECT_ID', defaultValue: '');
  static const firebaseIosStorageBucket =
